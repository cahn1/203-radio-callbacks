...
myheading1='Callback demo'
tabtitle = 'xkcd'
list_of_options=['alternative graphs', 'trust data', 'productivity', 'rp overview']
list_of_images=['alternative-graphs.jpg', 'trust-the-data.gif', 'productivity.gif', 'rp-overview.jpg', 'chart.jpg']
